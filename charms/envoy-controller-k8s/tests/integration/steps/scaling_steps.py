...
"""Scaling steps for the envoy-controller-k8s suite."""
...
@then("the envoy-gateway Pebble service is running on all units")
def pebble_running_all_units(juju: Juju) -> None:
    """Assert the envoy-gateway Pebble service is active on every unit."""
