...
.. py:class:: IngressConfigProvider(relation_mapping: ops.RelationMapping, app: ops.Application, relation_name: str = DEFAULT_RELATION_NAME)
   ...
   :param app: This application (the ingress charm).
   ...
   .. py:method:: get_ext_authz_provider_name() -> str | None
      ...
      :returns: The generated external authorizer provider name if available, else None.
   ...
   .. py:method:: is_ready() -> bool
      ...
      :returns: True if the external authorizer provider name has been published by the requirer.
   ...
   .. py:method:: publish(ext_authz_service_name: str | None = None, ext_authz_port: str | None = None, ext_authz_protocol: Literal['http', 'grpc'] = 'http', include_headers_in_check: list[str] | None = None, headers_to_upstream_on_allow: list[str] | None = None, headers_to_downstream_on_allow: list[str] | None = None, headers_to_downstream_on_deny: list[str] | None = None) -> None
      ...
      :param ext_authz_service_name: The external authorizer service name.
      :param ext_authz_port: The port number for the external authorizer service.
      :param ext_authz_protocol: The protocol used to communicate with the external authorizer.
      :param include_headers_in_check: Headers to forward to the external authorizer for checking.
      :param headers_to_upstream_on_allow: Headers to pass to upstream on successful auth.
      :param headers_to_downstream_on_allow: Headers to send to client on successful auth.
      :param headers_to_downstream_on_deny: Headers to send to client on denied auth.
...
.. py:class:: IngressConfigRequirer(relation_mapping: ops.RelationMapping, app: ops.Application, relation_name: str = DEFAULT_RELATION_NAME)
   ...
   .. py:method:: get_ext_authz_provider_name(relation: ops.Relation) -> str | None
      ...
      :returns: The external authorizer provider name if available, else None.
   ...
   .. py:method:: get_provider_ext_authz_info(relation: ops.Relation) -> ProviderIngressConfigData | None
      ...
      :returns: An instance of ProviderIngressConfigData if available and valid, else None.
   ...
   .. py:method:: is_fake_authz_config(relation: ops.Relation) -> bool
      ...
      :returns: True if the provider relation contains fake authz configuration, else False.
   ...
   .. py:method:: is_ready(relation: ops.Relation) -> bool
      ...
      :returns: True if both ext_authz_service_name and ext_authz_port are present.
   ...
   .. py:method:: publish_ext_authz_provider_name(relation: ops.Relation, unique_name: str) -> None
      ...
      :param relation: A specific relation instance.
      :param unique_name: The unique external authorizer provider name to publish.
